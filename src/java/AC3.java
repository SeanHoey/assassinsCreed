 ...
 */
@WebServlet(name = "AC3", urlPatterns = {"/AC3"})
public class AC3 extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            String XMLFileName = path + "/AssassinsCreedBrotherhood.xml";
            String XSLFileName = path + "/stuff.xsl";
